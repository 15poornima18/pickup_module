<%-- 
    Document   : ReqDashBoardM2
    Created on : 13 Jun, 2020, 4:46:59 PM
...
<body>
          ...
          <% String user = (String)session.getAttribute("User_id");
             ...
             ArrayList<ViewRequestM2> reqList = EmployeeLoginDao.listAllRequest(user);
         %>
        <ul>
    ...
    <button onclick="todaysReq()" class="refresh" style="background-color:rgb(0, 0, 255); border-radius: 5px; color: white;" >
     ...
     <div>
          <table class="table-responsive table-condensed table-striped" text-align="center" style="font-size: 15px; background-color: whitesmoke;">
             <thead>
